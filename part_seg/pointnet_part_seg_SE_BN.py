...
def get_model(point_cloud, input_label, is_training, cat_num, part_num, \
    ...
    # Add SE-Block after second convolution layer
    with tf.compat.v1.variable_scope('se_block1') as sc:
        out2 = se_block(out2, reduction_ratio=16)
        
    # Batch Normalization
    out2 = tf_util.batch_norm_for_conv2d(out2, is_training, bn_decay, scope='bn1')
    ...
    # Add SE-Block after forth convolution layer
    with tf.compat.v1.variable_scope('se_block2') as sc:
        out4 = se_block(out4, reduction_ratio=16)
        
    # Batch Normalization
    out4 = tf_util.batch_norm_for_conv2d(out4, is_training, bn_decay, scope='bn2')
