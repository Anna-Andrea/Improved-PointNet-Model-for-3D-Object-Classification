...
parser.add_argument('--model', default='pointnet_cls', help='Model name: pointnet_cls_se or pointnet_cls or pointnet_cls_basic [default: pointnet_cls]')
...
# Save to a new log file for PointNet(SE-block)
if FLAGS.model == 'pointnet_cls_se':
    LOG_FOUT = open(os.path.join(LOG_DIR, 'log_train_se_block.txt'), 'w')
else:
